#ifndef SPATIALRECONSTRUCTION_LOGGER_H
#define SPATIALRECONSTRUCTION_LOGGER_H
...
#endif
namespace gf {
///todo: add colorful logging system.
///note: differentate windows system and others.
enum LogColor {
  Reset = 0,
  Bold,
  Unbold,
...
#endif //SPATIALRECONSTRUCTION_LOGGER_H
