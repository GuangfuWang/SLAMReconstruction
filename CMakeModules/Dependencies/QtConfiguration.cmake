...
set(CMAKE_AUTOUIC_SEARCH_PATHS ${PROJECT_SOURCE_DIR}/SLAMReconstruction/UI/WindowUI/Designer)
...
find_package(Qt5 COMPONENTS Core Gui Widgets OpenGL MultimediaWidgets
        3DCore 3DRender 3DInput REQUIRED ${PATH_CONF})


set(Qt5_LIBS Qt5::Widgets Qt5::Core Qt5::Gui Qt5::OpenGL Qt5::MultimediaWidgets
        Qt5::3DCore Qt5::3DRender Qt5::3DInput)
if (${Qt5_FOUND})
